...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.boundary_identity_trainable = False
        self.use_boundary_loss = False
        self.boundary_loss_coef = 0.01
        self.boundary_footprint_loss_coef = 0.002
        self.boundary_edge_threshold = 0.2
        self.boundary_similarity_margin = 0.25
        self.boundary_max_points = 4096
